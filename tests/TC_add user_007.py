...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("link", name="Admin").dblclick()
    ...
    page.get_by_role("textbox", name="Type for hints...").fill("Fname")
    page.get_by_role("option", name="FName Mname LName").click()
    page.locator("form i").nth(1).click()
    page.locator("form i").nth(1).click()
    page.locator("form i").nth(1).click()
    page.get_by_role("option", name="Enabled").click()
    page.get_by_role("textbox").nth(2).click()
    page.get_by_role("textbox").nth(2).fill("Fname2")
    page.get_by_role("textbox").nth(3).click()
    page.get_by_role("textbox").nth(3).fill("Fname123@")
    page.get_by_role("textbox").nth(4).click()
    page.get_by_role("textbox").nth(4).fill("Fname")
